# Applied AI Mastery — Everyday Life
...
├── README.md
├── materials/
│   ├── lesson-01-better-requests/
│   ├── lesson-02-summaries/
│   ├── lesson-03-decisions/
│   ├── lesson-04-online-buying/
│   ├── lesson-05-deal-alerts/
│   ├── lesson-06-travel-planning/
│   ├── lesson-07-event-planning/
│   ├── lesson-08-investment-research/
│   ├── lesson-09-mini-app/
│   ├── lesson-10-room-cad/
│   ├── lesson-11-visual-storytelling/
│   └── lesson-12-personal-brand/
└── capstone/
```

Every lesson package will contain a student activity, instructor step-by-step script, source material or template, answer/reference guidance, a digital-life-management habit, and a lightweight completion check.