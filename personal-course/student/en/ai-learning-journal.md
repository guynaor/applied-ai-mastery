...
<!-- journal-tab: {"id":"session-04","title":"Session 4: From Prompt to Presentation"} -->
...
| --- | --- | --- | --- |
| Example: the walk I do every morning | My family | That the route is worth an early start | Gemini for stages 1–4; the Cloud speech studio to narrate; Claude for the deck, both formats |
|  |  |  |  |
...
| 6 Assemble | Claude | Asked Claude for a six-slide deck, once as PPTX and once as self-contained HTML | Two working decks with both clips and the narration in sync — one editable in Slides, one a single file that opens in any browser | Reordered two slides in both versions so the narration matched the visuals | Every generated slide keeps its own caption, in both files |
...
<!-- journal-tab: {"id":"session-06","title":"Session 6: Solve a Recurring Problem"} -->
