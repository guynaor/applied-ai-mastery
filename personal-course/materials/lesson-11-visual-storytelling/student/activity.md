# Lesson 11 — Tell Stories with Images and Video

**Time:** 20–30 minutes  
**Goal:** Turn a trip, event, or personal project into a short visual story without inventing what happened or ignoring consent.

## Choose one small story
...
> This story is for **[audience]**. After viewing it, I want them to feel or understand **[purpose]**.
...
Keep originals unchanged. Rename selected items in story order, such as `01-arrival.jpg`.
...
## Step 4 — Write prompts for one generated asset
...
> Create **[asset]** for **[format]**. Visual mood: **[mood]**. Include **[elements]**. Avoid **[misleading or unwanted elements]**. Do not depict real people or events that were not photographed. Leave space for **[text/caption]**.
