# Lesson 7 — Plan an Event With Friends

**Time:** 20–30 minutes  
**Goal:** Turn a vague group idea into a realistic event plan with clear choices, owners, deadlines, reminders, and one shareable invitation.
...
Use an upcoming birthday, dinner, picnic, study celebration, game night, or weekend gathering. Keep the scope manageable: 4–20 people and no more than three major decisions.

Write:

> We are planning **[event]** for **[people]** during **[date window]** with a total budget of **[amount]**.

Do not paste private contact details or sensitive information into an AI tool.

## Step 2 — Separate constraints from preferences

List at least three hard constraints and three preferences.
...
> Help me create a short group poll for this event. Ask only questions that affect the plan. Use no more than five questions. Include one question for date/time, one for budget, one for accessibility or dietary needs, and one for the main activity. Avoid collecting unnecessary personal information.

Review every question. Remove anything that is intrusive, vague, or irrelevant.

## Step 4 — Convert the poll result into a plan
...
Ask AI for a concise invitation and a poster prompt. Include only confirmed facts. Label any detail still pending.
