# AF-TRN-401 — Instructor Answer Key

## Core decision

The presentation should ask leadership to approve, revise, or reject a bounded 12-unit pilot concept. It must not imply approval of a commercial product launch.

## Supported claims

A strong deck may state that:
...
- The EUR 5,000 figure is an unapproved planning ceiling with unclear inclusions.
- The 2.5-hour assembly allowance is an estimate pending a build trial.
- Reuse of the current controller board remains contingent on connector-clearance validation.
- A possible customer host is not a confirmed pilot site.

## Unacceptable claims

Reduce credit if the deck says or implies that:

- The AquaNode Mini design is complete.
- The pilot or budget is approved.
- Production will begin on a committed date.
...
A photorealistic product rendering should be clearly labelled as a concept, because it can otherwise create false confidence that the geometry is final.

## Debrief questions

- Which slide contains the actual decision?
- Which statement is most likely to be misread as a commitment?
- Does any visual imply more certainty than the text supports?
- What information belongs in speaker notes rather than on the slide?
- What single revision most improves decision quality?
