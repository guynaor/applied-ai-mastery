(()=>{
  ...
  const copy={
    en:{
      ...
      personalBadge:'Personal track',personalTitle:'Applied AI for Everyday Life',personalText:'For anyone who wants to use AI for everyday decisions, planning, creativity, research, personal projects, and meaningful work.',personalMeta:'7 integrated sessions · 45–60 minutes each',
    ...
    he:{
      ...
      personalBadge:'המסלול האישי',personalTitle:'AI יישומי לחיי היום־יום',personalText:'לכל מי שרוצה להשתמש ב-AI להחלטות יום־יומיות, תכנון, יצירתיות, מחקר, פרויקטים אישיים ועבודה משמעותית.',personalMeta:'7 מפגשים משולבים · 45–60 דקות לכל מפגש',
