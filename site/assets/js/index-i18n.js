(()=>{
  ...
  const copy={
    ...
    he:{
      ...
      metaDescription:'בחרו קורס של Applied AI Mastery לעבודה מקצועית, להוראה ב-K–12 או לחיי היום־יום.',
      ...
      teacherBadge:'המסלול למורים',teacherTitle:'AI יישומי להוראה ב-K–12',teacherText:'למורים ומורות ב-K–12 שרוצים ליצור ולבדוק מערכי שיעור, חומרי למידה, תקצירי מחקר, ניתוחי גיליונות ציונים, מצגות, תהליכי עבודה ויישומים פשוטים לכיתה.',teacherMeta:'7 משימות + פרויקט מסכם משולב',
