# EDU-CAP-001 — תכנית יחידת מים ליסודי, לחטיבה או לתיכון שנבדקת בידי מורה

**תפקיד:** מורה ומקבל/ת ההחלטות ההוראתיות הסופי/ת

**תרחיש:** התאימו את יחידת **מים בעולמנו המשותף** הבדיונית בת השבועיים לשכבת גיל אחת שנבחרה, תוך הצגת האופן שבו אותו חקר מרכזי משתנה ליסודי, לחטיבה או לתיכון.
...
|---|---|
| יסודי | התבוננות מונחית במים, הקראה או רצף תמונות, ומיון ראיות עם תמיכות חזותיות ואפשרויות מענה בעל פה/חזותיות. |
| חטיבה | השוואת ראיות ממקורות, פירוש טבלה או גרף ובניית טענה מובנית בעזרת ראיות. |
| תיכון | השוואת טענות ופשרות, ביקורת מקור, שיטה ואי־ודאות, וניסוח טיעון אזרחי־אתי עם הפרכה. |
