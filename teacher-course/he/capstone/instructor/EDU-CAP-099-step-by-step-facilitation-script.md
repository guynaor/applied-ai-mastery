...
הלומד מנסח את הרצף בן עשרת הימים, בדיקות מעצבות, הערכה ודיפרנציאציה בשלוש שכבות. שאלו כיצד התבוננות מונחית ותמיכות חזותיות ליסודי, השוואת ראיות וטענה מובנית לחטיבה, וביקורת מקור, שיטה, אתיקה ואזרחות לתיכון משנים את אותו חקר. בחנו אפשרויות נגישות והבעה; אל תקבלו תחליף נמוך־חשיבה כדיפרנציאציה.
