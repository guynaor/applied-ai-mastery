...
פרויקט הגמר מאחד את שבע משימות מסלול המורים להחלטת תכנון יחידה המתאימה ליסודי, לחטיבה או לתיכון ונבדקת בידי מורה. התרחיש, עבודת הלומדים ודפוסי יומן הציונים הם בדיוניים; אין להוסיף שמות לומדים אמיתיים, ציונים, עבודות, פרטי קשר של משפחות או מידע מוגן.
