...
| --- | --- | --- | --- |
| יסודי | התבוננות מונחית, הקראה, רצף תמונות, חזרה בעל־פה וציור עם כיתוב מוכתב ותמיכות חזותיות. | הלומד/ת עדיין מקשר/ת ראיה להסבר. | בדיקת אוצר מילים ופירוש תמונות. |
| חטיבה | השוואת ראיות, טבלת נתונים מודרכת, פתיחי משפטים ומבנה טענה מובנית. | הלומד/ת עדיין מפרש/ת מקור ותצפית ומתקן/ת טענה. | הקשבה לשפת ראיות ובדיקת מבנה הטענה. |
| תיכון | ביקורת מקור, שיטה, אתיקה ואזרחות לצד אוסף ראיות של בעלי עניין וטיעון עם טענת־נגד. | הלומד/ת עדיין בונה טיעון מנומק ומבוסס מקור. | פגישת בדיקה לאחר יום 6. |
