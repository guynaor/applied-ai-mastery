...
| --- | --- | --- |
| יסודי | הקראה, חפצים מוחשיים, אוצר מילים נתמך תמונות והתבוננות מונחית; ללא טענות מפחידות על מחסור. | המורה מקריא/ה כיתוב מקור פשוט ושואל/ת: ״מה אתם מבחינים?״ |
| חטיבה | השוואת ראיות עם תרשימים מסומנים ושיח בזוגות, ובניית טענה מובנית. | התלמידים מזהים את המקור, מגבלותיו ועובדה מקומית חסרה. |
| תיכון | טיעון אזרחי־אתי עם נקודות מבט של כמה בעלי עניין וביקורת מקור ושיטה. | התלמידים שוקלים טענה מול איכות המקור, מגבלות השיטה וההיבט האתי או האזרחי ומציעים צעד בר־אימות. |
