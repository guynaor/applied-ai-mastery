...
6. **60–70 דק׳ — שיתוף ויציאה.** הזמינו התאמה אחת ליסודי (התבוננות מונחית ותמיכות חזותיות), אחת לחטיבה (השוואת ראיות וטענה מובנית) ואחת לתיכון (ביקורת מקור, שיטה, אתיקה או אזרחות). פתק יציאה: ציינו צעד אימות שבינה מלאכותית אינה יכולה לבצע במקום המורה.
